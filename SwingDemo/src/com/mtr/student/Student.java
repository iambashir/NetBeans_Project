...
public class Student extends javax.swing.JFrame {
    ...
    //creating database connection getConnection takes 3 parameters url, username, password
    Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/bashir", "root", "root");
    
    //createing mysql/sql query for select all data from schema bashir of table name student_data
    String query = "select * from bashir.student_data";
    Statement stmt = (Statement) con.createStatement();
    ResultSet rs = (ResultSet) stmt.executeQuery(query);
    
    //using a loop to set all data to table as index
    while (rs.next()) {
      int id = rs.getInt("id");
  ...
  private void btnsendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsendActionPerformed
    ...
    try {
      ...
      ps = (PreparedStatement) con.prepareStatement("insert into  bashir.student_data values (?, ?, ?, ?, ?)");
...
//      txtarea.setText("id is: " + id + "\nName is: " + name + "\nEmail is: "+ email + "\nAddrss is: " + address + "\nMobile is: " + mobile);
  ...
  private void btngetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btngetActionPerformed
    try {
      ...
      Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/bashir", "root", "root");
      PreparedStatement ps = null;
      ps = (PreparedStatement) con.prepareStatement("select * from bashir.student_data where id = ?");
