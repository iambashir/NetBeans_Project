                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="student_code" class="form-control" placeholder="" name="student_code">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="roll_no" class="form-control" placeholder="" name="roll_no">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="reg_no">Registration No</label>
                                            <input type="text" id="reg_no" class="form-control" placeholder="" name="reg_no">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="guardian_name" class="form-control" placeholder="" name="guardian_name">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="guardian_contact">Guardian Contact</label>
                                            <input type="text" id="guardian_contact" class="form-control" placeholder="" name="guardian_contact">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
							<div class="form-body">
								...
								<div class="row">
								    <div class="col-md-8">
										<div class="form-group">
                                     <label for="admit_date">Admission Date</label>
	                                     <ul class="list-inline mb-0">
											<li>
												<select id="admit_date" name="admit_date" class="form-control">
											      <option>Day</option>
											    </select>
										    </li>
											<li>
												<select id="admit_month" name="admit_month" class="form-control">
													<option>Month</option>
											    </select>
											</li>
											<li>
												<select id="admit_year" name="admit_year" class="form-control">
													<option>Year</option>
												</select>
											</li>
										</ul>
...
<script type="text/javascript">
	...
	for(var i = 0; i < options.length; i++) {
	  ...
	  $('<option>')
	    .val(('0' + month_number).slice(-2))          // set the value
	    .text(options[i])    // set the text in in the <option>
	    .appendTo($admit_month);
	}


	// :: YEAR
	var $admit_year = $("#admit_year");
